...
static short err_trans_table[] = {
	Success,       Err_nogood,          Err_no_file,     Err_no_path,       Err_too_many_files,
	Err_access,    Err_file_not_open,   Err_sys_mem_bad, Err_no_memory,     Err_bad_address,
	Err_bad_env,   Err_disk_format,     Err_file_access, Err_data,          Err_nogood,
	Err_no_device, Err_nogood,          Err_nogood,      Err_no_more_files, Err_write_protected,
	Err_no_device, Err_disk_not_ready,  Err_nogood,      Err_disk_data,     Err_nogood,
	Err_seek,      Err_not_dos_disk,    Err_sector,      Err_no_paper,      Err_read,
	Err_write,     Err_general_failure, Err_file_share,  Err_file_lock,     Err_disk_change,
...
{
	Errcode err;
	const short pj_crit_errval = 1 - 19;
